...
public class PlayerController extends Component {
    ...
    public Vector2f terminalVelocity = new Vector2f(2.0f, 3.0f);
    ...
    public void update(float dt) {
        ...
        checkOnGround();
        if ((KeyListener.isKeyPressed(GLFW_KEY_SPACE) && (onGround || jumpTime > 0 || groundDebounce > 0))) {
        ...
        this.velocity.x = Math.max(Math.min(this.velocity.x, terminalVelocity.x), -terminalVelocity.x);
    ...
    public void checkOnGround() {
        ...
        raycastBegin.sub(innerPlayerWidth / 2.0f, 0);
        ...
        Vector2f raycast2End = new Vector2f(raycastEnd).add(innerPlayerWidth, 0);
