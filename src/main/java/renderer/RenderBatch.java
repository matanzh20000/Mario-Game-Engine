...
public class RenderBatch implements Comparable<RenderBatch> {
    ...
    private void loadVertexProperties(int index) {
        ...
        if (isRotated) {
            ...
            transformMatrix.scale(sprite.gameObject.transform.scale.x, sprite.gameObject.transform.scale.y, 1.0f);
        }
        ...
        for (int i=0; i < 4; i++) {
            ...
            Vector4f currentPos = new Vector4f(sprite.gameObject.transform.position.x + (xAdd * sprite.gameObject.transform.scale.x),
                    vertices[offset + 1] = sprite.gameObject.transform.position.y + (yAdd * sprite.gameObject.transform.scale.y), 0, 1);
